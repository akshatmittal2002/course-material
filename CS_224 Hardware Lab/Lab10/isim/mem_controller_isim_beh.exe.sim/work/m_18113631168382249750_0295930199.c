...
static unsigned int ng26[] = {15173U, 0U};
static const char *ng27 = "";
static const char *ng28 = ",  curr=%d,  ss_add=%d,  ss_in=%d,  ss_out=%d,  rf_id=%d,  rf_in=%d,  rf_out=%d,  alu_out=%d, tmp=%d, op=%d";
...
LAB45:    xsi_set_current_line(215, ng0);
    ...
    xsi_vlogfile_write(0, 0, 0, ng27, 2, t0, (char)118, t44, 64);
    t3 = (t0 + 8840);
    t4 = (t3 + 56U);
    t5 = *((char **)t4);
    t7 = (t0 + 8040);
    ...
    t55 = (t54 + 56U);
    t56 = *((char **)t55);
    xsi_vlogfile_write(1, 0, 0, ng28, 11, t0, (char)118, t5, 5, (char)118, t10, 5, (char)118, t33, 16, (char)118, t42, 16, (char)118, t45, 4, (char)118, t48, 16, (char)118, t50, 16, (char)118, t51, 16, (char)118, t53, 16, (char)118, t56, 4);
    goto LAB2;
...
LAB93:    if (*((unsigned int *)t33) > 0)
        goto LAB94;

LAB95:    if (*((unsigned int *)t12) > 0)
        goto LAB96;

LAB97:    memcpy(t11, t42, 8);
...
LAB94:    xsi_vlog_unsigned_bit_combine(t11, 32, t37, 32, t42, 32);
    goto LAB98;

LAB96:    memcpy(t11, t37, 8);
    goto LAB98;
...
extern void work_m_18113631168382249750_0295930199_init()
{
	static char *pe[] = {(void *)Always_63_0,(void *)Always_70_1,(void *)Always_96_2,(void *)implSig1_execute};
	xsi_register_didat("work_m_18113631168382249750_0295930199", "isim/mem_controller_isim_beh.exe.sim/work/m_18113631168382249750_0295930199.didat");
